...
#ifndef bufIndexBits
/// @brief the buffer will be 2^bufIndexBits bytes long i.e. bufIndexBits=1 buffer = 2, 
/// bufIndexBits=2 buffer = 4, bufIndexBits=4 buffer = 16 etc. [2,4,8,16,32,64,128,256]bytes
#define bufIndexBits                                                                                                                                      \
...
#define bufMsk                                                                                                                                            \
     ...
     * @return byte
     */
    inline byte nextIndex(byte x) { return bufIndex((byte)(headP + (byte)lengthB) + (byte)x); }
